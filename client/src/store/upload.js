...
const PhotoUpload = () => {
    ...
    const upload = async() => {
        ...
        if (data.location) {
            const product = await fetchWithCSRF('/api/products/', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({  img:data.location, 
                                        title: "", 
                                        desc:description, 
                                        category:"", 
                                        price: 0.00, 
        ...
        <>
            ...
            <div className="upload-form">
                ...
                <div className="upload-text-area-div">
                    <TextField multiline={true} onChange={handleDescription} value={caption} placeholder="Write a caption"></TextField>
                </div>
                <div>
